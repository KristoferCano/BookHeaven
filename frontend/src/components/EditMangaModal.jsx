...
function EditMangaModal({ isOpen, onClose, onEdit, mangaItem }) {
    ...
    useEffect(() => {
        if (mangaItem) {
            setFormData({
                ...
                match: mangaItem.match || 85,
                age: mangaItem.age || '16+',
                duration: mangaItem.duration || '120 min',
                genres: mangaItem.genres || ['Drama'],
                description: mangaItem.description || '',
                poster: mangaItem.poster || '',
                backdrop: mangaItem.backdrop || ''
            })
        }
    }, [mangaItem])

    if (!isOpen || !mangaItem) return null
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://127.0.0.1:8000/api/mangas/${mangaItem.id}`, {
                method: 'PUT',
                body: data
            })
            ...
            console.error(error)
            alert('Error al actualizar el manga')
        }
    }
        ...
        <div className="modal-overlay">
            <div className="modal modal--edit">
                <div className="modal__header">
                    <h2 className="modal__title">Editar Manga</h2>
